...
import { BASE_FETCH_FIELDS } from './PayloadsFields';
...
export default function ManageBaseConfig({ addNew }) {
  ...
  const fetchAppBase = async () => {
    ...
    setBaseData(appBaseDefaultResponse.data.data[0]);
    setIsLoading(false);
    return appBaseDefaultResponse.data.data[0];
  };
        ...
        <div className="container-fluid">
          <div className="row">
            <div className="col-md-12">
              ...
              <BreadCrumb feature={feature} subFeature={subFeature} modeText={t('LBL_APP_BASE')} />
            </div>
          </div>
          <div className="row">
            <div className="col-md-12 mb-4">
              <div className="info-tite-page float-start">
                <h4>{t('LBL_APP_BASE')}</h4>
              </div>
