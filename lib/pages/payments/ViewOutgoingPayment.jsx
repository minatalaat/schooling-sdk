...
const ViewOutgoingPayment = ({ feature, subFeature }) => {
  const mode = 'view';
  ...
  const fetchPayment = async () => {
    ...
    if (status !== 0 || !data) navigate(getFeaturePath('OUTGOING_PAYMENTS'));
      ...
      <div className="container-fluid">
        <div className="row">
          <div className="col-md-12">
            <Calendar />
            <BreadCrumb feature={feature} subFeature={subFeature} modeText="LBL_VIEW_OUTGOING_PAYMENT" />
          </div>
        </div>
...
export default ViewOutgoingPayment;
