...
//   const editUser = async (addAddress, pictureID) => {
...
//     await api('POST', getUserProfilesUrl(), createUserPayload, onCreateUserActionSuccess);
//   };
...
//                 <BreadCrumb feature={feature} subFeature={subFeature} mode={mode} translationKey="USERS" />
//               </div>
//             </div>
//             <div className="row">
//               <div className="col-md-12">
...
//                       </div>
//                       <div className="col-md-4">
//                         <TextInput formik={formik} label="LBL_BUILDING_NUMBER" accessor="buildingNumber" mode="edit" isRequired={true} />
//                       </div>
//                       <div className="col-md-4">
//                         <TextInput formik={formik} label="LBL_STREET_NUMBER" accessor="streetNumber" mode="edit" isRequired={true} />{' '}
//                       </div>
//                       <div className="col-md-4">
...
//                       <Features
//                         isCard={true}
//                         setAssignedUserFeatures={setAssignedUserFeatures}
//                         edit={true}
//                         view={false}
