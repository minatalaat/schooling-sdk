...
function InventoryValuationFIFOReport({ feature, subFeature }) {
          ...
          <div className="row ">
            <div className="col-md-12 mb-4">
              <div className="info-tite-page float-start">
                <h4>{t('LBL_INVENTORY_VALUATION_FIFO_REPORT')}</h4>
              </div>
                ...
                <div className="row">
                  ...
                  <div className="col-md-6">
                    <SearchModalAxelor
                      ...
                      mode="add"
                      defaultValueConfig={null}
                      payloadDomain="self.productTypeSelect = 'storable' and self.dtype = 'Product' and self.costTypeSelect = 5"
                    />
                  </div>
                  <div className="col-md-6">
...
export default InventoryValuationFIFOReport;
