...
function NonReceivedSalesOrdersReport({ feature, subFeature }) {
  ...
  const generateReport = async () => {
    ...
    let reportPaylod = {
      action: 'action-print-non-received-sales-orders-report',
      data: {
          ...
          <div className="row ">
            <div className="col-md-12 mb-4">
              <div className="info-tite-page float-start">
                <h4>{t('LBL_NONRECEIVED_SALEORDERS_REPORT')}</h4>
              </div>
...
export default NonReceivedSalesOrdersReport;
