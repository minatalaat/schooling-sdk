...
function SupplierArrivalReport({ feature, subFeature }) {
  ...
  const generateReport = async () => {
    ...
    let reportPaylod = {
      action: 'action-print-delivery-not-invoiced-report',
      data: {
          ...
          <div className="row ">
            <div className="col-md-12 mb-4">
              <div className="info-tite-page float-start">
                <h4>{t('LBL_SUPPLIER_ARRIVAL_REPORT')}</h4>
              </div>
...
export default SupplierArrivalReport;
