...
function CostCenterTotalsReport({ feature, subFeature }) {
  ...
  const generateReport = async () => {
    ...
    let reportPaylod = {
      action: 'action-print-cost-center-report',
      data: {
          ...
          <div className="row ">
            <div className="col-md-12 mb-4">
              <div className="info-tite-page float-start">
                <h4>{t('LBL_COST_CENTER_TOTALS_REPORT')}</h4>
              </div>
...
export default CostCenterTotalsReport;
