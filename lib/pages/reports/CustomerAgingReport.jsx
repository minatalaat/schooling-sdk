...
function CustomerAgingReport({ feature, subFeature }) {
          ...
          <div className="row ">
            <div className="col-md-12 mb-4">
              <div className="info-tite-page float-start">
                <h4>{t('LBL_CUSTOMER_AGING_REPORT')}</h4>
              </div>
              ...
              <div className="card">
                <div className="row">
                  <div className="col-md-3">
                    <DateInput formik={formik} label="LBL_REPORT_DATE" accessor="reportDate" mode="add" isRequired={true} />{' '}
                  </div>
