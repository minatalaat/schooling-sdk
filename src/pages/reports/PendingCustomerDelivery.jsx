...
function PendingCustomerDelivery({ feature, subFeature }) {
  ...
  const generateReport = async () => {
    ...
    let reportPaylod = {
      action: 'action-pending-customer-delivery-report',
      data: {
          ...
          <div className="row ">
            <div className="col-md-12 mb-4">
              <div className="info-tite-page float-start">
                <h4>{t('LBL_PENDING_CUSTOMER_DELIVERY_REPORT')}</h4>
              </div>
                ...
                <div className="row">
                  ...
                  <div className="col-md-6">
                    <SearchModalAxelor
                      ...
                      payloadDomain="self.isContact = false AND self.isCustomer = true AND self.id!=1"
...
export default PendingCustomerDelivery;
