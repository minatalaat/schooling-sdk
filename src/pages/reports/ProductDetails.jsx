...
function ProductDetails({ feature, subFeature }) {
  ...
  const generateReport = async () => {
    ...
    let reportPaylod = {
      action: 'action-print-product-location-report',
      data: {
          ...
          <div className="row ">
            <div className="col-md-12 mb-4">
              <div className="info-tite-page float-start">
                <h4>{t('LBL_PRODUCT_DETAILS_REPORT')}</h4>
              </div>
            ...
            <div className="col-md-12">
              <div className="card">
                <div className="row">
                  ...
                  <div className="col-md-6">
                    <SearchModalAxelor formik={formik} modelKey="PRODUCTS" mode="add" isRequired={false} defaultValueConfig={null} />
                  </div>
                  <div className="col-md-6">
                    <SearchModalAxelor
                      formik={formik}
