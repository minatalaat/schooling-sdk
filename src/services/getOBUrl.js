...
export const getOBCreateLink = () => {
  //{{openbanking-url}}/create/accountLink
  return import.meta.env.VITE_OB_QAEMA_BASE_URL + OB_REST_ENDPOINTS.CREATE_LINK;
};

export const getOBUpdateLink = () => {
  //{{openbanking-url}}/update/accountLink
  return import.meta.env.VITE_OB_QAEMA_BASE_URL + OB_REST_ENDPOINTS.UPDATE_LINK;
};

export const getOBLink = () => {
  //{{openbanking-url}}/update/accountLink
  return import.meta.env.VITE_OB_QAEMA_BASE_URL + OB_REST_ENDPOINTS.GET_LINK;
};
...
export const getDeleteAccountLinkUrl = () => {
  return import.meta.env.VITE_OB_QAEMA_BASE_URL + OB_REST_ENDPOINTS.DELETE_LINK;
};
